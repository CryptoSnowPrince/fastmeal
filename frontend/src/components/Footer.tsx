        ...
        <footer className='w-full'>
            ...
            <div className='w-full text-white items-center px-5 flex flex-row my-5'>
                <div className="lg:w-1/3 w-2/3 flex flex-row text-center gap-2">
                    <Image src='/logo.png' width={80} height={80} alt='logo' className="lg:w-[80px] w-[40px] my-auto" />
                ...
                <div className="flex flex-row w-1/3 lg:gap-3 gap-1 lg:justify-center justify-end">
                    <Image src='/instagram_white.png' width={50} height={50} alt='logo' className="lg:w-[50px] w-[30px] my-auto" />
                    <Image src='/youtube_white.png' width={50} height={50} alt='logo' className="lg:w-[50px] w-[30px] my-auto" />
                    <Image src='/telegram_white.png' width={50} height={50} alt='logo' className="lg:w-[50px] w-[30px] my-auto" />
                    <Image src='/x_white.png' width={50} height={50} alt='logo' className="lg:w-[50px] w-[30px] my-auto" />
                </div>
            </div >
        </footer >
    );
