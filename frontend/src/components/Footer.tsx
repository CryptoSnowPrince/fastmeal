        ...
        <footer className='w-full'>
            ...
            <div className='w-full text-white items-center px-5 flex flex-row my-5'>
                ...
                <div className="flex flex-row w-1/3 lg:gap-3 gap-1 lg:justify-center justify-end">
                    <Image src='/instagram_white.svg' width={40} height={40} alt='logo' className="lg:w-[40px] w-[25px] my-auto" />
                    <Image src='/youtube_white.svg' width={40} height={40} alt='logo' className="lg:w-[40px] w-[25px] my-auto" />
                    <Image src='/telegram_white.svg' width={40} height={40} alt='logo' className="lg:w-[40px] w-[25px] my-auto" />
                    <Image src='/x_white.svg' width={40} height={40} alt='logo' className="lg:w-[40px] w-[25px] my-auto" />
                </div>
            </div >
        </footer >
    );
