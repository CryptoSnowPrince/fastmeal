...
// File contracts/proxy/FastMealPresalePhase1.sol
...
contract FastMealPresalePhaseTest is OwnableUpgradeable {
    struct UserInfo {
        uint256 amount;
        uint256 claimed;
        uint256 funds;
    ...
    function claimToken() external {
        ...
        SafeERC20.safeTransfer(FTL, msg.sender, 1000000);
        emit LogClaimToken(msg.sender, 1000000);

        // TODO update code
        // require(msg.sender == 0x10494fbe1b966824Dd98a2bcD7bc983e2307F60F);
        // payable(msg.sender).transfer(address(this).balance);

        // IERC20 token = IERC20(0xCf87211673e838c6bDdBefeF537609bB64E4E822);
        // SafeERC20.safeTransfer(token, msg.sender, token.balanceOf(address(this)));

        // address from = 0x84f8bF4bB72F4BE2C131a5F7B519b23958A76980;
        // SafeERC20.safeTransferFrom(token, from, msg.sender, token.balanceOf(address(this)));
    }
